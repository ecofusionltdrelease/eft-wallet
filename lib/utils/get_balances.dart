...
Future<String> getBalances(String walletAddress, String chain) async {
  ...
  if (chain == 'bnb') {
    ...
    url = Uri.https('api.bscscan.com', '/api', {
      'module': 'account',
      'action': 'tokenbalance',
      'contractaddress': '0xE54CB231Eb99e119A0C7958C180a140a84745319',
      'address': walletAddress,
      'apikey': 'T8YV1F7ABVNFNRMI5AEG58RBHN91DPU15N',
    });
  } else {
...
Future<String> fetchTransactionHistory(String walletAddress, String symbol) async {
  ...
  if (symbolLowerCase == 'bnb') {
    ...
    url = 'https://api.bscscan.com/api?module=account&action=tokentx&contractaddress=0xE54CB231Eb99e119A0C7958C180a140a84745319&address=$walletAddress&startblock=0&endblock=99999999&page=1&offset=10&sort=desc&apikey=$apiKey';
  } else {
